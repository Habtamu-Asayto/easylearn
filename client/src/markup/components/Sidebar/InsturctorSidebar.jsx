...
function InstructorSidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        className={`sidebar bg-white w-64 border-r border-gray-200 flex-shrink-0 fixed md:relative inset-y-0 z-50 transition-transform duration-300 ease-in-out overflow-y-auto scroll-smooth ${
